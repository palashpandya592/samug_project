...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
        ...
        fileUrlPrefix:
            json["fileUrlPrefix"] == null ? null : json["fileUrlPrefix"],
        hlsStatus: json["hlsStatus"] == null ? null : json["hlsStatus"],
        nextPage: json["nextPage"] == null ? null : json["nextPage"],
        nextPageSugg:
            json["nextPageSugg"] == null ? null : json["nextPageSugg"],
        postDetails: json["postDetails"] == null
            ? null
            : List<PostDetail>.from(
                json["postDetails"].map((x) => PostDetail.fromJson(x))),
        postGroup: json["postGroup"] == null
            ? null
            : List<PostGroup>.from(
                json["postGroup"].map((x) => PostGroup.fromJson(x))),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "postDetails": postDetails == null
            ? null
            : List<dynamic>.from(postDetails!.map((x) => x.toJson())),
        "postGroup": postGroup == null
            ? null
            : List<dynamic>.from(postGroup!.map((x) => x.toJson())),
...
class PostDetail {
  ...
  factory PostDetail.fromJson(Map<String, dynamic> json) => PostDetail(
        ...
        followStatus:
            json["followStatus"] == null ? null : json["followStatus"],
        ...
        suggestionMode:
            json["suggestionMode"] == null ? null : json["suggestionMode"],
        userLikeStatus:
            json["userLikeStatus"] == null ? null : json["userLikeStatus"],
        watchStatus: json["watchStatus"] == null ? null : json["watchStatus"],
        zamugDisplayName:
            json["zamugDisplayName"] == null ? null : json["zamugDisplayName"],
...
class PostDetails {
  ...
  factory PostDetails.fromJson(Map<String, dynamic> json) => PostDetails(
        ...
        postCommentsCount: json["postCommentsCount"] == null
            ? null
            : json["postCommentsCount"],
        postDetails: json["postDetails"] == null ? null : json["postDetails"],
        postDhan: json["postDhan"] == null
            ? null
            : List<PostDhan>.from(
                json["postDhan"].map((x) => PostDhan.fromJson(x))),
        postDhanCount:
            json["postDhanCount"] == null ? null : json["postDhanCount"],
        postDislikes:
            json["postDislikes"] == null ? null : json["postDislikes"],
        postExclusiveTag: json["postExclusiveTag"],
        postLanguage: json["postLanguage"] == null
            ? null
            : List<String>.from(json["postLanguage"].map((x) => x)),
        postLastUpdate:
            json["postLastUpdate"] == null ? null : json["postLastUpdate"],
        postLikes: json["postLikes"] == null ? null : json["postLikes"],
        postMetadata:
            json["postMetadata"] == null ? null : json["postMetadata"],
        postPersonalTag: json["postPersonalTag"],
        postRewards: json["postRewards"] == null ? null : json["postRewards"],
        postSnapshoot:
            json["postSnapshoot"] == null ? null : json["postSnapshoot"],
        postThumbnail: json["postThumbnail"] == null
            ? null
            : List<dynamic>.from(json["postThumbnail"].map((x) => x)),
        postTimestamp:
            json["postTimestamp"] == null ? null : json["postTimestamp"],
        postTrendingTag: json["postTrendingTag"] == null
            ? null
            : List<String>.from(json["postTrendingTag"].map((x) => x)),
        postType: json["postType"] == null ? null : json["postType"],
        postVisibility:
            json["postVisibility"] == null ? null : json["postVisibility"],
        postZamugTag: json["postZamugTag"] == null
            ? null
            : List<PostZamugTag>.from(
                json["postZamugTag"].map((x) => PostZamugTag.fromJson(x))),
        postadminRemarks: json["postadminRemarks"] == null
            ? null
            : List<dynamic>.from(json["postadminRemarks"].map((x) => x)),
        postcreatedDate: json["postcreatedDate"] == null
            ? null
            : DateTime.parse(json["postcreatedDate"]),
        postfiles: json["postfiles"] == null
            ? null
            : List<String>.from(json["postfiles"].map((x) => x)),
        poststatus: json["poststatus"] == null ? null : json["poststatus"],
        shareCount: json["shareCount"] == null ? null : json["shareCount"],
        shareOtherCount:
            json["shareOtherCount"] == null ? null : json["shareOtherCount"],
        sharedBy: json["sharedBy"] == null ? null : json["sharedBy"],
        transcodeDetails:
            json["transcodeDetails"] == null ? null : json["transcodeDetails"],
        transcodeUid:
            json["transcodeUid"] == null ? null : json["transcodeUid"],
  ...
  Map<String, dynamic> toJson() => {
        ...
        "postCommentsCount":
            postCommentsCount == null ? null : postCommentsCount,
        "postDetails": postDetails == null ? null : postDetails,
        "postDhan": postDhan == null
            ? null
            : List<dynamic>.from(postDhan!.map((x) => x.toJson())),
        ...
        "postLanguage": postLanguage == null
            ? null
            : List<dynamic>.from(postLanguage!.map((x) => x)),
        ...
        "postThumbnail": postThumbnail == null
            ? null
            : List<dynamic>.from(postThumbnail!.map((x) => x)),
        "postTimestamp": postTimestamp == null ? null : postTimestamp,
        "postTrendingTag": postTrendingTag == null
            ? null
            : List<dynamic>.from(postTrendingTag!.map((x) => x)),
        "postType": postType == null ? null : postType,
        "postVisibility": postVisibility == null ? null : postVisibility,
        "postZamugTag": postZamugTag == null
            ? null
            : List<dynamic>.from(postZamugTag!.map((x) => x.toJson())),
        "postadminRemarks": postadminRemarks == null
            ? null
            : List<dynamic>.from(postadminRemarks!.map((x) => x)),
        "postcreatedDate": postcreatedDate == null
            ? null
            : "${postcreatedDate!.year.toString().padLeft(4, '0')}-${postcreatedDate!.month.toString().padLeft(2, '0')}-${postcreatedDate!.day.toString().padLeft(2, '0')}",
        "postfiles": postfiles == null
            ? null
            : List<dynamic>.from(postfiles!.map((x) => x)),
